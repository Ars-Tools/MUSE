...
extension Arithmetic {
    @frozen public struct Add<X: Tensor<Element>, Y: Tensor<Element>> {
...
extension Arithmetic.Add: ElasticTensor & Operator.BinaryTensor where X: ElasticTensor, Y: ElasticTensor {
    public typealias S = Arithmetic.Add<X.S, Y.S>
    public typealias T = Arithmetic.Add<X.T, Y.T>
    public typealias U = Arithmetic.Add<X.U, Y.U>
    public typealias V = Arithmetic.Add<X.V, Y.V>
}
@_disfavoredOverload
public func +<Element: ArithmeticElement, X: Tensor<Element>, Y: Tensor<Element>>(_ lhs: X, _ rhs: Y) -> Arithmetic<Element>.Add<X, Y> {
