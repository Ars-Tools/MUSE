...
extension Arithmetic {
	@usableFromInline
	struct Mul<LHS: Tensor<Element>, RHS: Tensor<Element>> {
		@usableFromInline typealias R = Array<Element>
		@usableFromInline typealias S = Mul<LHS.S, RHS.S>
		@usableFromInline typealias T = Mul<LHS.T, RHS.T>
		@usableFromInline typealias U = Mul<LHS.U, RHS.U>
		@usableFromInline typealias V = Mul<LHS.V, RHS.V>
...
extension Arithmetic.Mul: Immediate where LHS: Immediate, RHS: Immediate {
	@usableFromInline
	@inline(__always)
...
extension Arithmetic.Mul: Scalar where LHS: Scalar, RHS: Scalar {}
extension Arithmetic.Mul: Vector where LHS: Vector, RHS: Vector {
	@inlinable@inline(__always)@_transparent
	var count: Int {
...
extension Arithmetic.Mul: Matrix where LHS: Matrix, RHS: Matrix {
	@inlinable@inline(__always)@_transparent
	var rows: Int {
...
public func *<Element: ArithmeticElement>(_ lhs: some Scalar<Element>, _ rhs: some Scalar<Element>) -> some Scalar<Element> {
	Arithmetic.Mul(lhs: lhs, rhs: rhs)
}
@_disfavoredOverload
