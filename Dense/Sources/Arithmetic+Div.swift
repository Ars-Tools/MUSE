...
extension Arithmetic {
    @usableFromInline
    @frozen struct Div<X: Tensor<Element>, Y: Tensor<Element>> {
        @usableFromInline typealias R = Array<Element>
        @usableFromInline typealias S = Div<X.S, Y.S>
        @usableFromInline typealias T = Div<X.T, Y.T>
        @usableFromInline typealias U = Div<X.U, Y.U>
        @usableFromInline typealias V = Div<X.V, Y.V>
...
extension Arithmetic.Div: Scalar & Operators.BinaryScalar where X: Scalar, Y: Scalar {}
extension Arithmetic.Div: Vector & Operators.BinaryVector where X: Vector, Y: Vector {}
extension Arithmetic.Div: Matrix & Operators.BinaryMatrix where X: Matrix, Y: Matrix {}
extension Arithmetic.Div: Tensor & Operators.BinaryTensor where X: Tensor, Y: Tensor {
...
extension Arithmetic.Div: InstantScalar where X: InstantScalar, Y: InstantScalar {}
extension Arithmetic.Div: InstantVector where X: InstantVector, Y: InstantVector {}
extension Arithmetic.Div: InstantMatrix where X: InstantMatrix, Y: InstantMatrix {}
