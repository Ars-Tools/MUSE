...
extension Arithmetic {
    public struct Div<X: Tensor<Element>, Y: Tensor<Element>> {
        ...
        public typealias T = Div<X.T, Y.T>
        public typealias U = Div<X.U, Y.U>
        public typealias V = Div<X.V, Y.V>
...
extension Arithmetic.Div: Operator.BinaryTensor {
            ...
            await withUnsafePointer(xm(), ym()) { x, y in
                .init(unsafeUninitializedCapacity: zm) {
                    ...
                    for offset in offset {
                        Element.Div(x: x.advanced(by: offset.x), inc: stride.x,
...
@_disfavoredOverload
public func /<Element, X, Y>(_ lhs: X, _ rhs: Y) -> Arithmetic<Element>.Div<X, Y> {
