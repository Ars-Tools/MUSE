...
extension Arithmetic {
	@usableFromInline
	struct Sub<LHS: Tensor<Element>, RHS: Tensor<Element>> {
		@usableFromInline typealias R = Array<Element>
		@usableFromInline typealias S = Sub<LHS.S, RHS.S>
		@usableFromInline typealias T = Sub<LHS.T, RHS.T>
		@usableFromInline typealias U = Sub<LHS.U, RHS.U>
		@usableFromInline typealias V = Sub<LHS.V, RHS.V>
...
extension Arithmetic.Sub: Immediate where LHS: Immediate, RHS: Immediate {
	@usableFromInline
	@inline(__always)
...
extension Arithmetic.Sub: Scalar where LHS: Scalar, RHS: Scalar {}
extension Arithmetic.Sub: Vector where LHS: Vector, RHS: Vector {
	@inlinable@inline(__always)@_transparent
	var count: Int {
...
extension Arithmetic.Sub: Matrix where LHS: Matrix, RHS: Matrix {
	@inlinable@inline(__always)@_transparent
	var rows: Int {
...
public func -<Element: ArithmeticElement>(_ lhs: some Scalar<Element>, _ rhs: some Scalar<Element>) -> some Scalar<Element> {
	Arithmetic.Sub(lhs: lhs, rhs: rhs)
}
@_disfavoredOverload
