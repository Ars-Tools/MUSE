...
@usableFromInline
enum Solver<Element: SolverElement & ArithmeticElement> {}
public protocol SolverElement: BLASElement & SparseScalar<Self> {
    associatedtype SparseOpaqueFactorization
    associatedtype SparseOpaquePreconditioner
    ...
    @inlinable static func SPMM(m: Int, n: Int, k: Int,
                                colStart: UnsafePointer<Int>,
                                rowIndex: UnsafePointer<Int32>,
                                valArray: UnsafePointer<Self>,
                                opA: Op,
    ...
    @inlinable static func Solve(factorization: SparseOpaqueFactorization, nrhs: Int,
                                 Y: UnsafePointer<Self>, ldY: Int, opY: Op,
...
extension Float32: SolverElement {
    ...
    @inlinable@_transparent
    public static func SPMM(m: Int, n: Int, k: Int,
                            colStart: UnsafePointer<Int>,
                            rowIndex: UnsafePointer<Int32>,
                            valArray: UnsafePointer<Self>,
                            opA: Op,
    ...
    @inlinable@_transparent
    public static func Solve(factorization: SparseOpaqueFactorization, nrhs: Int,
                             Y: UnsafePointer<Self>, ldY: Int, opY: Op,
                             X: UnsafeMutablePointer<Self>, ldX: Int, opX: Op) {
        let m = factorization.symbolicFactorization.rowCount
        let n = factorization.symbolicFactorization.columnCount
        let k = Int32(nrhs)
        let y = switch opY {
        case.T,.C:
