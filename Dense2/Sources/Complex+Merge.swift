...
extension Complex {
    public struct Ortho<X: ElasticTensor<Element.Magnitude>, Y: ElasticTensor<Element.Magnitude>> {
    ...
    public struct Polar<X: ElasticTensor<Element.Magnitude>, Y: ElasticTensor<Element.Magnitude>> {
        public typealias Storage = Array<Element>
