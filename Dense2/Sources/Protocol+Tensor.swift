...
public protocol MutableTensor<Element>: ElasticTensor where S: MutableTensor<Element>, T: MutableTensor<Element>, U: MutableTensor<Element>, V: MutableTensor<Element> {
